...
func NewLocalFileTrack(file string, trackKey string, paused func() bool, playYet func(trackKey string, trackPlayHead int64, offset int64, seekPosition int64) bool, options ...ReaderSampleProviderOption) (*LocalTrack, error) {
	// File health check
	var err error
...
func NewLocalBucketTrack(trackReader *storage.Reader, seekPosition int64, file string, trackKey string, paused func() bool, playYet func(trackKey string, trackPlayHead int64, offset int64, seekPosition int64) bool, options ...ReaderSampleProviderOption) (*LocalTrack, error) {
	// Determine mime type from extension
	var mime string
	switch filepath.Ext(file) {
	case ".h264":
